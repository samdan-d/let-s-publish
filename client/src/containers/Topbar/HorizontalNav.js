...
const HorizontalNav = (props) => {
  ...
  return (
    <Menu
      ...
      {/*  <Link to="/posts">*/}
      {/*    <i className=" icon icon-card"/> Home*/}
      {/*  </Link>*/}
      {/*</Menu.Item>*/}

      {/*<Menu.Item key=" comments" className=" top-menu-item">*/}
      {/*  <Link to="/comments">*/}
      {/*    <i className=" icon icon-message"/> Technology*/}
      {/*  </Link>*/}
      {/*</Menu.Item>*/}

      {/*<Menu.Item key=" categories" className=" top-menu-item">*/}
      {/*  <Link to="/categories">*/}
      {/*    <i className=" icon icon-cards-list-view"/> Entertainment*/}
      {/*  </Link>*/}
      {/*</Menu.Item>*/}

      {/*<Menu.Item key=" tags" className=" top-menu-item">*/}
      {/*  <Link to="/tags">*/}
      {/*    <i className=" icon icon-tag-new"/> Sport*/}
      {/*  </Link>*/}
      {/*</Menu.Item>*/}
      ...
      <SubMenu className={getNavStyleSubMenuClass} key=" in-built-apps"
      ...
      <SubMenu className={getNavStyleSubMenuClass} key=" extraComponents"
      ...
      <SubMenu className={getNavStyleSubMenuClass} key=" extensions"
      ...
      <SubMenu className={getNavStyleSubMenuClass} key=" custom-views"
